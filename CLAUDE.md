...
- **Styling priority**: Tailwind utility classes first → Bootstrap helpers → `ava-panel`/`ava-btn` layer components (`src/index.css @layer components`) → `<style scoped>` last resort.
