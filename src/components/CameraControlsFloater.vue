		...
		<div class="containerQ flex flex-col gap-[3px] p-[5px] select-none">
			...
			<div class="flex gap-[3px]">
				...
				<div class="flex flex-col items-center gap-[2px] w-[9cqi] shrink-0">
					...
					<!-- Zoom In -->
					<button
						class="custom sqtiny flex items-center justify-center bg-card2 hover:bg-accent2 active:bg-accent/50 border border-brd/70 hover:border-accent rounded-sm w-full aspect-square font-bold text-t1 cursor-default transition-colors"
						title="Zoom in (hold)"
					...
					<!-- Zoom Out -->
					<button
						class="custom flex items-center justify-center bg-card2 hover:bg-accent2 active:bg-accent/50 border border-brd/70 sqtiny hover:border-accent rounded-sm w-full aspect-square font-bold text-t1 cursor-default transition-colors"
						title="Zoom out (hold)"
						@mousedown.prevent="startZoom(1)"
						@mouseup="stopZoom"
						@mouseleave="stopZoom"
