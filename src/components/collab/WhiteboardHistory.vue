<script setup>
/**
 * WhiteboardHistory — Panel showing archived whiteboards for the current room.
 * Users can view past boards they had access to (read-only).
 */
...
<template>
	<div class="history-panel">
		...
		<div class="history-body">
			...
			<div v-else-if="!boards.length" class="history-empty">
