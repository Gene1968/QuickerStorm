<script setup>
/**
 * CollabDocHistory — Panel showing archived collaborative docs for the current room.
 */
defineProps({
...
<template>
	<div class="history-panel">
		...
		<div class="history-body">
			...
			<div v-else-if="!docs.length" class="history-empty">No archived docs yet.</div>
			<div v-else class="history-list">
				...
				>
					<div class="item-title">{{ doc.title || 'Untitled' }}</div>
					<div class="item-meta">
						<span>{{ formatDate(doc.archived_at || doc.created_at) }}</span>
						<span v-if="doc.access === 'private'" class="item-private">Private</span>
					</div>
				</button>
			</div>
		</div>
