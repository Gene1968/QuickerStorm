...
<template>
	<div class="flex flex-row gap-3">
		<select
			class="flex-1 w-full px-3 py-2 rounded-sm bg-card2 border border-brd text-t1 focus:outline-hidden focus:ring-2 focus:ring-accent"
		...
		<button
			...
			class="px-2 py-2 rounded-sm border border-brd hover:border-red-500 text-t2 hover:text-red-500 transition-colors"
		...
		<a
			...
			class="px-2 py-2 rounded-sm border border-brd bg-accent2 text-white hover:opacity-80 transition-colors text-sm"
