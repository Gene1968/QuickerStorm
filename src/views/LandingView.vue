			...
			<div class="flex flex-col items-start gap-5 px-5 py-4">
				...
				<div class="shrink-0 flex flex-col gap-1 w-full pt-0.5">
					<div class="flex items-center justify-between gap-2">
						<h1 class="flex items-center font-orbitron font-bold text-3xl text-fg whitespace-nowrap">
							<span title="quickerSTORM logo" class="inline-block me-2 w-7 h-7 text-transparent">
